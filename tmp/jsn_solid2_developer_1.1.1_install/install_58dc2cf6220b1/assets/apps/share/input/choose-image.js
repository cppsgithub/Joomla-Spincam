 ...
 */
window.SunFwInputChooseImage = React.createClass( {
	...
	selectImage: function( event ) {
		...
		href = 'index.php?sunfwwidget=images&action=index&author=joomlashine&rformat=raw&handler=jInsertFieldValue'
		...
		// Define functions to save selected image and close modal.
