...
// Cover the problem which causes article`s dropdown button disappear after hiding the dropdown menu.
(function($) {
	$(document).ready(function() {
		$('.icons > .btn-group.pull-right').on('hidden.bs.dropdown', function() {
			if (window.MooTools && typeof this.show == 'function') {
				this.show();
			}
		});
	});
