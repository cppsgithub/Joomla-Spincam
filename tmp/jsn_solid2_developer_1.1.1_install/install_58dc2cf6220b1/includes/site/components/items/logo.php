...
<div class="sunfw-logo<?php echo $classVisible; ?>">
	<a href="<?php echo $link; ?>" title="<?php echo $sitename; ?>">
		<img class="logo hidden-xs hidden-sm img-responsive <?php echo $class; ?>" alt="<?php echo $logoAlt; ?>" src="<?php echo $logo; ?>">
		<img class="logo hidden-lg hidden-md img-responsive <?php echo $class; ?>" alt="<?php echo $logoAlt; ?>" src="<?php echo $logoMobile; ?>">
	</a>
</div>
