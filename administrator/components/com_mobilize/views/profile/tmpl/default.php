                    ...
                    <div class="jsn-mobilize">
                        <div class="jsn-form-bar">
                            ...
                            <div class="pull-right">
                                ...
                                <!--Begin Dialog Back To Top-->
                                <?php
                                $backToTop = array();
                                $bttShow = 1;
                                $bttAlign = 'center';
                                $bttText = JText::_('JSN_MOBILIZE_BACK_TO_TOP');
                                $bttPadding = 8;
                                $bttBackground = '#000000';
                                $bttColor = '#EEEEEE';
                                $bttStyle = !empty( $this->_style->jsn_back_to_top ) ? ( get_magic_quotes_gpc() == true || get_magic_quotes_runtime() == true ) ? stripslashes( $this->_style->jsn_back_to_top ) : $this->_style->jsn_back_to_top : '{"show":"1","align":"center","text":"Back To Top","padding":"10","color":"#FFFFFF","background":"#000000"}';
                                $bttStyle = !empty( $this->_style->jsn_back_to_top ) ? ( get_magic_quotes_gpc() == true || get_magic_quotes_runtime() == true ) ? stripslashes( $this->_style->jsn_back_to_top ) : $this->_style->jsn_back_to_top : '{"show":"1","align":"center","text":"Back To Top","padding":"10","color":"#FFFFFF","background":"#000000"}';
                                $backToTop = json_decode($bttStyle, true);
                                $bttShow  = $backToTop['show'];
                                $bttTitle = $backToTop['text'];
                                $bttAlign = $backToTop['align'];
                                $bttPadding = $backToTop['padding'];
                                $bttBackground = $backToTop['background'];
                                $bttColor = $backToTop['color'];
                                ?>
                                <div class="jsn-bootstrap form-horizontal" id="container-custom-back-to-top" style="padding: 20px;">
                                    <div class="control-group">
                                        <label class="control-label"><?php echo JText::_( 'JSN_MOBILIZE_BACK_TO_TOP_SHOW' );?></label>
                                        <div class="controls">
                                            <label class="radio inline">
                                                <input type="radio" name="btt_show" value="0" class="btt_show jsn-check-enable" <?php if($bttShow == 0){echo 'checked';}?>>
                                                No
                                            </label>
                                            <label class="radio inline">
                                                <input type="radio" name="btt_show" value="1" class="btt_show jsn-check-enable"  <?php if($bttShow == 1){echo 'checked';}?>>
                                                Yes
                                            </label>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label"><?php echo JText::_( 'JSN_MOBILIZE_BACK_TO_TOP_ALIGN' );?></label>
                                        <div class="controls">
                                            <select name="" id="btt_align" data-selected="" class="input-medium">
                                                <option value="left" <?php if($bttAlign == 'left'){echo 'selected';}?>>Left</option>
                                                <option value="center" <?php if($bttAlign == 'center'){echo 'selected';}?>>Center</option>
                                                <option value="right" <?php if($bttAlign == 'right'){echo 'selected';}?>>Right</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label"><?php echo JText::_( 'JSN_MOBILIZE_BACK_TO_TOP_TEXT' );?></label>
                                        <div class="controls">
                                            <input type="text" id="btt_text" class="jsn-borderThickness" name="back_to_top_text" value="<?php echo $bttTitle;?>"/>
                                        </div>
                                    </div>
                                    <div class="control-group" style="display: none;">
                                        <label class="control-label"><?php echo JText::_( 'JSN_MOBILIZE_BACK_TO_TOP_PADDING' );?></label>
                                        <div class="controls">
                                            <input type="number" id="btt_padding" class="jsn-borderThickness" name="back_to_top_padding" value="<?php echo $bttPadding;?>"/> px
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label"><?php echo JText::_( 'JSN_MOBILIZE_BACK_TO_TOP_COLOR' );?></label>
                                        <div class="controls">
                                            <input type="text" id="btt_color" class="jsn-borderThickness" name="back_to_top_color" value="<?php echo $bttColor;?>" readonly/>
                                            <span id="btt_color_selector_container">
                                                <div class="jsn-select-color jsn-bttColor input-small" id="btt_color_selector"><div style="background-color: <?php echo $bttColor;?>"></div></div>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label"><?php echo JText::_( 'JSN_MOBILIZE_BACK_TO_TOP_BACKGROUND' );?></label>
                                        <div class="controls">
                                            <input type="text" id="btt_background" class="jsn-borderThickness" name="back_to_top_background" value="<?php echo $bttBackground;?>" readonly/>
                                            <span id="btt_background_selector_container">
                                                <div class="jsn-select-color jsn-bttBgColor input-small" id="btt_background_selector"><div style="background-color: <?php echo $bttBackground;?>"></div></div>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                <!--End Dialog Back To Top-->
                                <!--Begin Dialog Social-->
                                            ...
                                            <div id="mobilize-design" class="jsn-section-content">
                                                <div id="jsn-mobilize" class="jsn-layout">
                                                    ...
                                                    <div class="jsn-total">
                                                        ...
                                                        <div class="jsn-row-container row-fluid" id="back_to_top_container" style="text-align: <?php echo $bttAlign;?> ">
                                                            <a href="javascript:void(0);" id="select_back_to_top"
                                                               title="<?php echo jText::_( 'JSN_MOBILIZE_BACK_TO_TOP' );?>"
                                                               style="margin-bottom: 15px;<?php echo 'color: '.$bttColor.'; background-color: '.$bttBackground.'; padding: '.$bttPadding.'px';?>">
                                                                <?php echo $bttTitle;?>
                                                            </a>
                                                            <div style="height: 10px; display: block"></div>
                                                            <input type="hidden" id="input_style_jsn_back_to_top" class="jsn-input-style" name="style[jsn_back_to_top]" value='<?php echo  htmlentities( $bttStyle );?>' />
                                                        </div>
                                                    </div>
                                                    <?php
