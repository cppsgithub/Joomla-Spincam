...
var id=$link.attr('href').substr($link.attr('href').indexOf('#')+1);if(id==''){return;}var scroll=false;var is_tab=true;var $anchor=$('a[data-toggle="tab"][data-id="'+id+'"]');if(!$anchor.length){$anchor=$('#'+id+',a[name="'+id+'"]');if(!$anchor.length){return;}
