...
/**
 * Subinstall script for finalizing JSN PageBuilder 2 content plugin for loading module via ID.
 *
 * @package  JSN_PageBuilder2
 */
class PlgContentPB2LoadModuleInstallerScript
{
	/**
	...
	/**
	 * Enable JSN PageBuilder 2 content plugin.
	 *
