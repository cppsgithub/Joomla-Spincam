...
<div class="processing-installation">
	...
	<ul id="sunfw-update-processes">
		<li id="sunfw-download-package">
			<span class="title"><?php echo JText::_('SUNFW_AUTO_UPDATE_DOWNLOAD_PACKAGE'); ?></span>
		...
		<li id="sunfw-backup-modified-files" class="hidden">
			<span class="title"><?php echo JText::_('SUNFW_AUTO_UPDATE_CREATE_LIST_UPDATED'); ?></span>
			<span class="status fa"></span>
		...
		<li id="sunfw-download-framework" class="hidden">
			<span class="title"><?php echo JText::_('SUNFW_AUTO_UPDATE_FRAMEWORK_DOWNLOAD_PACKAGE'); ?></span>
			<span class="status fa"></span>
			<div class="progress hidden">
				<div class="progress-bar" role="progressbar">
					<span class="percentage">0%</span>
		...
		<li id="sunfw-install-framework" class="hidden">
			<span class="title"><?php echo JText::_('SUNFW_AUTO_UPDATE_FRAMEWORK_INSTALL'); ?></span>
			<span class="status fa"></span>
			<div class="alert alert-danger hidden"></div>
		</li>
		<li id="sunfw-install-update" class="hidden">
			<span class="title"><?php echo JText::_('SUNFW_AUTO_UPDATE_INSTALL'); ?></span>
			<span class="status fa"></span>
			<div class="alert alert-danger hidden"></div>
		</li>
	</ul>
