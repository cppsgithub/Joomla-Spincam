...
class SunFwAjaxLayout extends SunFwAjax
{
	...
	public function getAction() {
		 ...
		 */
		$prebuilds = SunFwHelper::findTemplateAdminJsonSettings(
			SunFwHelper::getLayoutDirectories( $this->templateName ),
			'*.json',
			false,
		...
		$this->setResponse(
			array(
				...
				'prebuilds' => $prebuilds,
				'settings'  => SunFwHelper::findTemplateAdminJsonSettings(
					JPATH_ROOT . '/plugins/system/sunfw/assets/joomlashine/admin/js/layout/settings',
					'page.json',
					true
				)
			)
	...
	public function saveAction()
	{
		...
		$this->setResponse( array( 'message' => JText::_( 'SUNFW_LAYOUT_SAVED_SUCCESSFULLY' ) ) );
	}
