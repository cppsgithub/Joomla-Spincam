...
class SunFwScssrender
{
    ...
    public function sectionParams($array,$type){
        switch ($type) {
            case 'heading':
                $arr = array('custom' => 0,'headings-color' => 'false', 'headings-text-transform' => 'false', 'headings-text-shadow-h-shadow' => 0,
                'headings-text-shadow-v-shadow' => 0, 'headings-text-shadow-blur' => 0, 'headings-text-shadow-color' =>'false',
                'headings-base-size' => 'false', 'headings-line-height' => 'false', 'headings-letter-spacing' => 'false', 'headings-font-weight' => 'false'); 
                break;
            case 'content':
                $arr = array('custom' => 0,'color' => 'false', 'font-size-base' => 'false', 'line-height' => 'false'); 
                break;                            
            case 'link':
                $arr = array('custom' => 0,'link-color' => 'false', 'link-color-hover' => 'false');  
                break;
            case 'section':
                $arr = array('background-color' => 'false', 'background-image' => 'false', 'background-image-settings-repeat' => 'false', 'background-image-settings-attachment' => 'false',
                            'background-image-settings-size' => 'false', 'background-image-settings-position' => 'false', 'border-universal' => 'false', 'border-width' => 'false', 'border-style' => 'false',
                            'border-color' => 'false', 'border-top-width' => 'false', 'border-top-style' => 'false', 'border-top-color' => 'false', 'border-right-width' => 'false',
                            'border-right-style' => 'false', 'border-right-color' => 'false', 'border-bottom-width' => 'false', 'border-bottom-style' => 'false',
                            'border-bottom-color' => 'false', 'border-left-width' => 'false', 'border-left-style' => 'false', 'border-left-color' => 'false');
                break;
            case 'buttonDefault':
                $arr = array(
                    'btn-default-padding-top' => 'false', 'btn-default-padding-bottom' => 'false', 'btn-default-padding-right' => 'false', 'btn-default-padding-left' => 'false',
                    'btn-default-bg' => 'false', 'btn-default-border-all-universal' => 'false', 'btn-default-border-all-width' => 'false',
                    'btn-default-border-all-style' => 'false', 'btn-default-border-all-color' => 'false',
                    'btn-default-border-all-top-width' => 'false', 'btn-default-border-all-top-style' => 'false', 'btn-default-border-all-top-color' => 'false',
                    'btn-default-border-all-right-width' => 'false', 'btn-default-border-all-right-style' => 'false', 'btn-default-border-all-right-color' => 'false',
                    'btn-default-border-all-bottom-width' => 'false', 'btn-default-border-all-bottom-style' => 'false', 'btn-default-border-all-bottom-color' => 'false',
                    'btn-default-border-all-left-width' => 'false', 'btn-default-border-all-left-style' => 'false', 'btn-default-border-all-left-color' => 'false',
                    'btn-default-radius-top-left' => 'false', 'btn-default-radius-top-right' => 'false', 'btn-default-radius-bottom-right' => 'false',
                    'btn-default-radius-bottom-left' => 'false', 'btn-default-box-shadow-h-shadow' => 'false', 'btn-default-box-shadow-v-shadow' => 'false',
                    'btn-default-box-shadow-blur' => 'false', 'btn-default-box-shadow-spread' => 'false', 'btn-default-box-shadow-color' => 'false',
                    'btn-default-box-shadow-inset' => 'false', 'btn-default-color' => 'false', 'btn-default-font-weight' => 'false', 'btn-default-font-style' => 'false',
                    'btn-default-text-transform' => 'false', 'btn-default-text-shadow-h-shadow' => 'false', 'btn-default-text-shadow-v-shadow' => 'false',
                    'btn-default-text-shadow-blur' => 'false', 'btn-default-text-shadow-color' => 'false', 'btn-default-base-size' => 'false',
                    'btn-default-letter-spacing' => 'false', 'btn-default-bg-hover' => 'false', 'btn-default-border-hover' => 'false',
                    'btn-default-color-hover' => 'false', 'custom' => 'false');
                break;
            case 'buttonPrimary':
                $arr = array(
    ...
    public function moduleParams($array,$type) {
        switch ($type) {
            ...
            case 'content':
                ...
                break;
            case 'link':
                $arr = array('link-color' => 'false', 'link-hover-color' => 'false');
                break;
            case 'module':
                $arr = array(
                            'padding-top' => 'false',
        ...
        if ($s == "appearance") {
            ...
            try {
                ...
                if (isset($appearanceData['general'])) {
                    ...
                    // Content Font
                    if (isset($genaral['content']['content-google-font-family']) && is_array($genaral['content']['content-google-font-family']) && $genaral['content']['content-font-type'] != 'standard' && $genaral['content']['content-font-type'] != 'custom') {
                    ...
                    if (isset($genaral['content']['color'])) {
                        $genaral['content']['text-color'] = $genaral['content']['color'];
                    }
                ...
                if (isset($appearanceData['sections'])) {
                    ...
                    foreach ($sections as $key => $section) {
                        ...
                        if (isset($section['container'])) {
                            ...
                            if ($container) $scss_content .= "@include section(" . implode(",", $container) . ");";
                        ...
                        if (isset($section['heading'])) {
                            ...
                            if ($heading) $scss_content .= "@include section-heading(" . implode(",", $heading) . ");";
                ...
                if (isset($appearanceData['module'])) {
                    ...
                    foreach ($modules as $key => $module_style) {
                        ...
                        if (isset($module_style['container'])) {
                            ...
                            if ($module_container) $scss_content .= "@include module-container(" . implode(",", $module_container) . ");";
