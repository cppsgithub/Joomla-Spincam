...
class SunFwScsscompile
{
    ...
    public function scssCompile($templateName, $compiledFileName)
    {
        ...
        try {
            if ($this->getPath()) $this->scss->setImportPaths($this->getPath());
            if ($this->getFormat()) $this->scss->setFormatter($this->getFormat());
            if ($this->getVars()) $this->scss->setVariables($this->getVars());
