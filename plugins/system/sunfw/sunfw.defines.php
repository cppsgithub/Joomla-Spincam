...
define( 'SUNFW_VERSION', '1.2.4' );
define( 'SUNFW_RELEASED_DATE', '04/25/2017' );
...
define( 'SUNFW_VIDEO_TUTORIALS_URL', 'https://www.joomlashine.com/docs/joomla-templates/template-configuration-videos.html' );
