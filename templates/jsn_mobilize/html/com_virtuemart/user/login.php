...
if(!class_exists('JSNMobilizeHelper')) require_once(JPATH_ROOT . '/administrator/components/com_mobilize/helpers/mobilize.php');
...
if ($this->show and $user->id == 0  ) {
    ...
    <form action="<?php echo JRoute::_('index.php'); ?>" method="post" name="com-login" >
        ...
        <p class="width30 floatleft" id="com-form-login-remember">
            <input type="submit" name="Submit" class="default button" value="<?php echo JText::_('COM_VIRTUEMART_LOGIN') ?>" />
