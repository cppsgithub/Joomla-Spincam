...
if($this->print){
	...
	/* Print view URL */
	$details_url = juri::root().'index.php?option=com_virtuemart&view=orders&layout=details&tmpl=component&virtuemart_order_id=' . $this->orderdetails['details']['BT']->virtuemart_order_id .'&order_pass=' . $app->input->getString('order_pass', '') .'&order_number='.$app->input->getString('order_number', '');
